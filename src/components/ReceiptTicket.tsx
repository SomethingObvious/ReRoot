...
export default function ReceiptTicket({ receipt, full }: ReceiptTicketProps) {
  return (
    <div className="bg-white rounded-t-3xl relative pb-6 shadow-deep">
      {/* Header */}
      <div className="px-6 pt-6 pb-4 border-b border-dashed border-muted">
        <p className="text-center text-xs text-muted-foreground font-outfit tracking-widest uppercase">
          {receipt.store}
        </p>
        <p className="text-center text-2xl font-bold font-outfit text-earth mt-1">
      ...
      {/* Summary */}
      <div className="px-6 pt-3 border-t border-dashed border-muted">
